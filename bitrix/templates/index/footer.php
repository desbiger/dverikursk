...
<noscript>
	<div><img src = "//mc.yandex.ru/watch/17337745" style = "position:absolute; left:-9999px;" alt = ""/></div>
</noscript>
<!-- /Yandex.Metrika counter -->
...
<div id = "element_to_pop_up2" style = "display:none">
	<div class = "style_popap">
		...
		<div style = "width: 400px; line-height: 22px; color: #686868; font-size: 14px">Для получения более подробной информации по
		                                                                                ...
		                                                                                условиям
		                                                                                сотрудничества, необходимо связаться с сотрудниками
		                                                                                нашей компании:<br> по телефону <b>8 800
		                                                                                                                   450-02-80</b>,либо
		                                                                                отправить запрос на email :
			<span style = "color: #0D77BD"><?=$mail?></span>
		</div>
	</div>
